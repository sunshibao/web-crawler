...
func generatePageDownloaderPool(poolSize uint32, httpClientGenerator GenHttpClient) (dl.PageDownloaderPool, error) {
	dlPool, err := dl.NewPageDownloaderPool(poolSize,
